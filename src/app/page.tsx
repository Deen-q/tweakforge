        ...
        <main className="flex flex-1 flex-col justify-center items-center bg-slate-700 p-6">
          <div className="flex flex-col items-center space-y-2">
            ...
            <div className="flex flex-col items-center max-w-[30rem]">
              ...
              >
                <div className={toggleDivDimensions}>
                  <p>tl;dr: scripts are just a list of instructions, like a recipe. but instead of baking a cake, these scripts change registry files on your computer - basically extra settings that might be difficult to reach otherwise. some scripts also restart services or programs to apply changes immediately</p>
                </div>
              </ToggleDropdown>
